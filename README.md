...
- `iysl-transglobe` — apply 全球藍 design to PowerPoint, Word, Excel charts, HTML, and SVG while preserving data and meaning; SVG-first with editable surrounding content.
