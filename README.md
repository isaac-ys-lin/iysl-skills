...
- `iysl-transglobe` — select suitable 全球藍 charts from the question and data, generate SVG from 18 bundled chart types, and restyle Office or HTML while preserving data and meaning.
