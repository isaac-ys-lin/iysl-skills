...
assert(matrixSvg.includes('data-x-threshold="3"') && matrixSvg.includes('data-y-threshold="8"') && matrixSvg.includes('data-highlighted-quadrant="TL"') && matrixSvg.includes('甲案 -2／12') && !matrixSvg.includes('評分依據') && !matrixSvg.includes('NaN'));
