...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| S1 | [source] | [filing / issuer_ir / provider_export / user_excerpt / public_web / news / internal] | [company_filings_ir / earnings_transcripts_presentations / market_data_estimates / portfolio_models_trackers / internal_research] | [public_web / callable_connector / user_provided_account_data / local_file] | [public / user-authorized / user-provided / unclear] | [verified / unavailable / blocked / terms_blocked / stale / not_checked] | [date or period] | [timestamp/date/unknown] | [timestamp + timezone] | [direct location + section/page/field] | [current / historical-only / stale / unknown] | [high / medium / low] | [fallback source/reason, use, conflict, caveat] |
